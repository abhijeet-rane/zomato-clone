...
import userImg from '/images/emptyprofile.jpg';
...
const User = () => {
    ...
    let data3 = [
        {userId: 123, imgSrc:userImg, userName: "Pratik Patil", reviews: 120, followers: "240"},
        {userId: 123, imgSrc:userImg, userName: "Rohan Wani", reviews: 92, followers: "57"},
        {userId: 123, imgSrc:userImg, userName: "Pranav Fegade", reviews: 205, followers: "257"},
        {userId: 123, imgSrc:userImg, userName: "Kartik Saste", reviews: 174, followers: "93"}
    ]
