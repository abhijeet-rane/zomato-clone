...
const OrderOnlineFieldComponent = () => {
  ...
  const foodItemsData = {
    recommended: [
      {mustTry:true, ttl:"Hariyali Kebab", votes:"12", price:"1400", desc:"Tandoori Prawns [6 Pieces]+Fish Tikka [6 Pieces]+Kebab [6 Pieces]+Schezwan Tikka [6 Pieces]", vegNonveg:vegIcon, foodType: "veg"},
      {mustTry:true, ttl:"Hariyali Kebab", votes:"12", price:"1400", desc:"Tandoori Prawns [6 Pieces]+Fish Tikka [6 Pieces]+Kebab [6 Pieces]+Schezwan Tikka [6 Pieces]", vegNonveg:vegIcon, foodType: "veg"},
      {mustTry:true, ttl:"Hariyali Kebab", votes:"12", price:"1400", desc:"Tandoori Prawns [6 Pieces]+Fish Tikka [6 Pieces]+Kebab [6 Pieces]+Schezwan Tikka [6 Pieces]", vegNonveg:vegIcon, foodType: "veg"},
      {mustTry:true, imgSrc:hariyalikebab, ttl:"Hariyali Kebab", votes:"12", price:"1400", desc:"Tandoori Prawns [6 Pieces]+Fish Tikka [6 Pieces]+Kebab [6 Pieces]+Schezwan Tikka [6 Pieces]", vegNonveg:vegIcon, foodType: "veg"},
      {mustTry:true, imgSrc:hariyalikebab, ttl:"Hariyali Kebab", votes:"12", price:"1400", desc:"Tandoori Prawns [6 Pieces]+Fish Tikka [6 Pieces]+Kebab [6 Pieces]+Schezwan Tikka [6 Pieces]", vegNonveg:vegIcon, foodType: "veg"}
    ],
    biryanis: [
      {mustTry:true, ttl:"Hariyali Kebab", votes:"12", price:"1400", desc:"Tandoori Prawns [6 Pieces]+Fish Tikka [6 Pieces]+Kebab [6 Pieces]+Schezwan Tikka [6 Pieces]", vegNonveg:vegIcon, foodType: "veg"},
